...
<footer class="main-footer text-sm">
  <div class="container">
        ...
        <div class="float-right d-none d-sm-inline-block">
          <b><?php echo $_settings->info('short_name') ?> (by: <a href="mailto:marygrace@gmail.com" target="blank">Mary Grace</a> )</b> v1.0
        </div>
      </div>
      </footer>
    </div>
...
<div id="libraries">
    ...
    <script src="<?php echo base_url ?>template/js/Chart.roundedBarCharts.js"></script>
    <script src="<?php echo base_url ?>template/js/category.js"></script>
</div>
